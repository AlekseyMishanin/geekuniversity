package javacoreadvanced.lesson5;
...
public class App {
    public static void main(String[] args) {
        ...
        Configuratoin conf = new Configuratoin();
        //решение первой задачи
        SimpleArray.processArray(new float[conf.getSize()]);
        //решение второй задачи
        try {
            MultithreadedArray.processArray(conf.getCountThreads(),new float[conf.getSize()]);
